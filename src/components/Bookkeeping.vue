<template>
  <div>
    <h1 class="title animate__animated animate__fadeIn">Bookkeeping</h1>
...
.calculator {
  ...
  box-shadow: 41px 41px 15px #122937, -41px -41px 15px #2e6d91;
  padding: 24px;
  border-radius: 20px;
}
...
.calculator_Box {
  ...
  background: #204b64;
  box-shadow: inset 10px 10px 8px #173749, inset -10px -10px 8px #295f7f;
}
</style>
